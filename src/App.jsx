        ...
        <div className="pt-32 pb-20 bg-neutral-900 min-h-screen">
            <div className="container mx-auto px-6">
                ...
                <div className="mt-12 p-10 border border-white/10 bg-black flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <a href="https://wa.me/6285641117775?text=Halo%20Vorvox%2C%20saya%20ingin%20konsultasi%20pembuatan%20jersey.%20Bisa%20dibantu%3F" target="_blank" rel="noreferrer"
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-16">
                <div>
                    ...
                    <div className="flex gap-3">
                        <a href="https://wa.me/6285641117775?text=Halo%20Vorvox%2C%20saya%20ingin%20konsultasi%20pembuatan%20jersey.%20Bisa%20dibantu%3F" target="_blank" rel="noreferrer" title="WhatsApp" className="w-9 h-9 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all cursor-pointer text-gray-400">
                            <Phone size={16} />
                        </a>
